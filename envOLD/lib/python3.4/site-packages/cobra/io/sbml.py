...
def create_cobra_model_from_sbml_file(sbml_filename, old_sbml=False,
    ...
    print("inicio metodo create_cobra_model_from_sbml_file")
    print("model_doc={0}".format(model_doc))
    print("model_doc.printErrors()={0}".format(model_doc.printErrors()))
    print("model_doc.getLocationURI()={0}".format(model_doc.getLocationURI()))
    if model_doc.getPlugin("fbc") is not None:
        print("model_doc.getPlugin={0}".format(model_doc.getPlugin("fbc")))
        ...
        print("conversion_properties={0}".format(conversion_properties))
